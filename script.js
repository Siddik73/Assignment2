...
let isCanvasVisible = true; // ⚡ Bolt: Track visibility to prevent off-screen rendering
...
function animate() {
    ...
    // ⚡ Bolt: Only render when the canvas is in the viewport to save GPU/CPU cycles
    if (isCanvasVisible) {
