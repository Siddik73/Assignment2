...
let isRendering = true; // Tracks if canvas is in viewport
...
function init3D() {
    ...
    // Performance: Pause Three.js rendering when out of viewport
...
function animate() {
    ...
    // Optimization: Skip GPU render call if canvas is not visible
    if (isRendering) {
