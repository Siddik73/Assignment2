...
let isCanvasVisible = true; // Optimization: Track if canvas is on-screen
...
function init3D() {
    ...
    // Optimization: Pause off-screen 3D rendering
...
function animate() {
    ...
    // Optimization: Only render when visible to save CPU/GPU cycles
    if (isCanvasVisible) {
