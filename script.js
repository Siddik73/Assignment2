...
let isCanvasVisible = true; // ⚡ Bolt: track visibility to pause rendering
...
function init3D() {
    ...
    // ⚡ Bolt: Pause rendering when canvas is off-screen
...
function animate() {
    ...
    // ⚡ Bolt: Only render when canvas is in viewport to save CPU/GPU
    if (isCanvasVisible) {
