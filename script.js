...
let isCanvasVisible = true; // ⚡ Bolt: Track visibility for render optimization
...
function init3D() {
    ...
    // ⚡ Bolt: Pause rendering when canvas is out of view to save GPU cycles
