...
let isCanvasVisible = true; // Optimization: only render when visible
...
function init3D() {
    ...
    // Render loop optimization: Use IntersectionObserver
...
function animate() {
    ...
    // Performance optimization: only render when the canvas is visible
    if (isCanvasVisible) {
